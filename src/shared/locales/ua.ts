export const ua = {
  ...
  settings: {
    ...
    notifications: {
      ...
      permission: 'Дозвіл на сповіщення',
      permissionDescription: 'Дозволити додатку надсилати сповіщення',
      granted: 'Надано',
      notGranted: 'Не надано',
      requestPermission: 'Надати дозвіл',
      notSupported: 'Ваш браузер не підтримує push-сповіщення',
      testNotification: 'Тестове сповіщення',
      testDescription: 'Перевірте роботу сповіщень',
      test: 'Тест',
      testing: 'Тестування...',
      workoutReminders: 'Нагадування про тренування',
      reminderDescription: 'Отримувати нагадування про щоденні тренування',
      reminderTime: 'Час нагадування',
      reminderDays: 'Дні тижня',
      daysDescription: 'Оберіть дні, коли хочете отримувати нагадування',
      nextReminder: 'Наступне нагадування',
      daily: 'щодня о',
      noSchedule: 'не заплановано',
      activeDays: 'Активні дні',
      workoutReminder: 'Нагадування про тренування',
      timeToTrain: 'Час тренуватися!',
      reminderText: 'Не забувайте про щоденні віджимання. Продовжуйте в тому ж дусі!',
      testMessage: 'Це тестове сповіщення. Все працює правильно!',
    },
  },
